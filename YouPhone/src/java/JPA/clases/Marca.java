...
@NamedQueries({
    ...
    , @NamedQuery(name = "Marca.findByNmarca", query = "SELECT m FROM Marca m WHERE m.nmarca = :nmarca")})
public class Marca implements Serializable {
    ...
    public Marca(Integer id, String nmarca) {
        this.id = id;
        this.nmarca = nmarca;
    }
