...
public class Smartphones implements Serializable {
    ...
    public Smartphones(Integer id, int bid, String pantalla, String potencia, String camara, String sensor, String modelo, Date publicado, String dimensiones, int peso, int bateria, String colores, String contenido, String imagemini, BigDecimal precio) {
        this.id = id;
        this.bid = bid;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Smartphones)) {
            return false;
        }
        Smartphones other = (Smartphones) object;
